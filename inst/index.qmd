...
intro <- tryCatch(
    {
        description <- packageDescription("babybook2")
...
👉 [ghcr.io/vjcitn/babybook2](https://ghcr.io/vjcitn/babybook2) 🐳
...
#| eval: false
docker run -it ghcr.io/vjcitn/babybook2:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/vjcitn/babybook2:devel
```
...
#| eval: false
docker run -it ghcr.io/vjcitn/babybook2:devel bash
